...
|               |                                            |                                                                          |                       |               |     |
|               | **Generate html from data using template** | →service classe that recive data and return html                         |                       | **9 hours**   |     |
...
|               |                                            | create Cover Page component                                              | :white_check_mark:    | **3 hours**   |     |
|               |                                            | create T.O.C component                                                   | :white_check_mark:    | **9 hours**   |     |
