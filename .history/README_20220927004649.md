...
מסמך זה מהווה תיאור כללי ומפורט של הצורך ביצירת תהליך אוטומטי להפקת קבצי PDF שתוכנם )כל אחד מהם(
מתעד תוכנית לימודים כפי שהופיע באתר האוניברסיטה במועד ההפקה. תוכנית לימודים היא, למעשה, תואר
)ולמדייקים: שילוב של חוג, תואר, אופן לימוד ומסלול(.
